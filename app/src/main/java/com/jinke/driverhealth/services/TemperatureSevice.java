...
public class TemperatureSevice {
    ...
    public static void requestTemperatureDataFromTuDY(final OkGoCallback callback) throws IOException {

        String url = "https://openapi.xu5g.com/tsp/temperatures/get?start_time=2021-10-01 00:00:00&end_time=2022-01-21 00:00:00&page=1&limit=4";
